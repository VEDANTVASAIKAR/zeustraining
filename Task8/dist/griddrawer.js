...
export class GridDrawer {
     ...
     */
    drawVisibleCell(row, col, value, rows, cols, scrollLeft, scrollTop) {
     ...
     * @param cols - Column manager instance
     */
    drawVisibleGridLines(startRow, endRow, startCol, endCol, rows, cols) {
        ...
        for (let i = startRow; i <= endRow; i++) {
            // Draw horizontal line at the top of each row
            const line = new Line(0 - this.container.scrollLeft, // Start from the left edge of the canvas, adjusted for scroll
        ...
        for (let i = startCol; i <= endCol; i++) {
            // Draw vertical line at the left of each column
            const line = new Line(x + 0.5 - this.container.scrollLeft, // Position adjusted for scroll
     ...
     * @param cols - Column manager instance
     */
    drawVisibleHeaders(startRow, endRow, startCol, endCol, rows, cols) {
