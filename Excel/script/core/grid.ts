...
export class Grid {
    ...
    private static readonly TILE_WIDTH = 1920;
    private static readonly TILE_HEIGHT = 560;
    private container: HTMLElement;
    private scrollArea: HTMLElement;
    // Keeps track of which tiles (segmentX, segmentY) are already rendered
    private renderedSegments: Set<string> = new Set();

    constructor(container: HTMLElement, scrollArea: HTMLElement) {
     ...
     */
    private renderVisibleCanvases(): void {
     ...
     */
    private createTileCanvas(tileX: number, tileY: number): void {
